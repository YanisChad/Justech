...
async function fetchKeyboard() {
    ...
    await page.waitForSelector('#app > div > div.product-list > div.product-list__main-wrapper > main > div.vue-recycle-scroller.product-list__products.ready.page-mode.direction-vertical > div.vue-recycle-scroller__item-wrapper', {
        visible: true
    });
